...
counter = 1
for data in extracted_images['easy']:
        # Save the image data to a file
        image_path = os.path.join(NOTEBOOK_DESK, '_', '{}.jpg'.format(counter))
        counter += 1
        with open(image_path, 'wb') as f:
            f.write(data)
# print(extracted_images['hard'])
    # 一鍵生成的試題
# one_button_path = os.path.join(NOTEBOOK_EXERCISE_PATH, 'calculus', 'one_button', 'exam1.pdf')
